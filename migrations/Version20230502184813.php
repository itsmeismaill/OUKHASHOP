 ...
 */
final class Version20230502184813 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD category_id INT DEFAULT NULL, ADD user_id INT NOT NULL, ADD img_path VARCHAR(255) DEFAULT NULL, ADD brochure_filename VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP category_id, DROP user_id, DROP img_path, DROP brochure_filename');
    }
}
